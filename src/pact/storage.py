...
def storage_operation(operation: str, source: Path, destination: Path, *,
    ...
    if operation not in ("snapshot", "bundle", "bundle-restore", "warmstart-restore", "collection-restore", "feasibility-restore", "receiver-restore", "private-control-restore", "curated-repair-restore", "prompt-control-restore", "preparation-probe-restore", "preparation-references-restore") or not 0 < timeout_seconds < float("inf"):
...
def _worker(control: Path) -> int:
    ...
    try:
        if request["operation"] == "preparation-references-restore":
        ...
        elif request["operation"] in ("warmstart-restore", "collection-restore", "feasibility-restore", "receiver-restore", "private-control-restore", "curated-repair-restore", "preparation-probe-restore", "prompt-control-restore"):
            ...
            kind = {"warmstart-restore":"warmstart", "collection-restore":"training_bank",
                    ...
                    "prompt-control-restore":"preparation_prompt_control",
