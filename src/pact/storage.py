...
def _worker(control: Path) -> int:
    ...
    try:
        ...
        elif request["operation"] in ("receiver-supervision-restore", "warmstart-restore", "collection-restore", "feasibility-restore", "receiver-restore", "private-control-restore", "curated-repair-restore", "preparation-probe-restore", "prompt-control-restore"):
            from .training.colab import _restore_snapshot
            kind = {"receiver-supervision-restore":"receiver_supervision", "warmstart-restore":"warmstart", "collection-restore":"training_bank",
