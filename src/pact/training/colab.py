...
def _restore_snapshot(snapshot: Path, destination: Path, *, progress=lambda message: None, kind="warmstart"):
    ...
    if kind not in ("warmstart", "training_bank", "preference_feasibility_diagnostic", "receiver_feasibility_diagnostic", "private_support_control", "curated_repair_diagnostic"):
    ...
    if kind in ("preference_feasibility_diagnostic", "private_support_control", "curated_repair_diagnostic"):
    ...
    if kind in ("receiver_feasibility_diagnostic", "private_support_control", "curated_repair_diagnostic"):
